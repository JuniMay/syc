...
#line 147 "frontend/generated/parser.cpp"
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_FLOATING: // FLOATING
        value.YY_MOVE_OR_COPY< ComptimeValuePtr > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      case symbol_kind::S_INTEGER: // INTEGER
      case symbol_kind::S_FLOATING: // FLOATING
        value.move< ComptimeValuePtr > (YY_MOVE (that.value));
        break;
   ...
   Parser ::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      case symbol_kind::S_INTEGER: // INTEGER
      case symbol_kind::S_FLOATING: // FLOATING
        value.copy< ComptimeValuePtr > (that.value);
        break;
   ...
   Parser ::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      case symbol_kind::S_INTEGER: // INTEGER
      case symbol_kind::S_FLOATING: // FLOATING
        value.move< ComptimeValuePtr > (that.value);
        break;
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      case symbol_kind::S_INTEGER: // INTEGER
      case symbol_kind::S_FLOATING: // FLOATING
        yylhs.value.emplace< ComptimeValuePtr > ();
        break;
...
#line 1104 "frontend/generated/parser.cpp"
    break;

  case 28: // Def: IDENTIFIER ArrayIndices '=' InitVal
#line 227 "frontend/parser.y"
                                        {
    TypePtr decl_type = driver.curr_decl_type;
...
#line 1133 "frontend/generated/parser.cpp"
    break;
...
#line 1141 "frontend/generated/parser.cpp"
    break;
...
#line 1150 "frontend/generated/parser.cpp"
    break;
...
#line 1158 "frontend/generated/parser.cpp"
    break;
...
#line 1166 "frontend/generated/parser.cpp"
    break;
...
#line 1174 "frontend/generated/parser.cpp"
    break;
...
#line 1182 "frontend/generated/parser.cpp"
    break;
...
#line 1191 "frontend/generated/parser.cpp"
    break;

  case 36: // IfStmt: IF '(' Cond ')' Stmt
#line 286 "frontend/parser.y"
                                    {
    yylhs.value.as < ast::StmtPtr > () = ast::create_if_stmt(yystack_[2].value.as < ast::ExprPtr > (), yystack_[0].value.as < ast::StmtPtr > (), driver, std::nullopt);
  }
#line 1199 "frontend/generated/parser.cpp"
    break;

  case 37: // IfStmt: IF '(' Cond ')' Stmt ELSE Stmt
#line 289 "frontend/parser.y"
                                   {
    yylhs.value.as < ast::StmtPtr > () = ast::create_if_stmt(yystack_[4].value.as < ast::ExprPtr > (), yystack_[2].value.as < ast::StmtPtr > (), driver, std::make_optional(yystack_[0].value.as < ast::StmtPtr > ()));
  }
#line 1207 "frontend/generated/parser.cpp"
    break;

  case 38: // WhileStmt: WHILE '(' Cond ')' Stmt
#line 295 "frontend/parser.y"
                            {
    yylhs.value.as < ast::StmtPtr > () = ast::create_while_stmt(yystack_[2].value.as < ast::ExprPtr > (), yystack_[0].value.as < ast::StmtPtr > (), driver);
  }
#line 1215 "frontend/generated/parser.cpp"
    break;

  case 39: // ReturnStmt: RETURN Expr ';'
#line 301 "frontend/parser.y"
                    {
    yylhs.value.as < ast::StmtPtr > () = ast::create_return_stmt(std::make_optional(yystack_[1].value.as < ast::ExprPtr > ()), driver);
  }
#line 1223 "frontend/generated/parser.cpp"
    break;

  case 40: // ReturnStmt: RETURN ';'
#line 304 "frontend/parser.y"
               {
    yylhs.value.as < ast::StmtPtr > () = ast::create_return_stmt(std::nullopt, driver);
  }
#line 1231 "frontend/generated/parser.cpp"
    break;
...
#line 1239 "frontend/generated/parser.cpp"
    break;
...
#line 1247 "frontend/generated/parser.cpp"
    break;
...
#line 1255 "frontend/generated/parser.cpp"
    break;
...
#line 1264 "frontend/generated/parser.cpp"
    break;
...
#line 1273 "frontend/generated/parser.cpp"
    break;
...
#line 1281 "frontend/generated/parser.cpp"
    break;
...
#line 1289 "frontend/generated/parser.cpp"
    break;

  case 48: // Cond: LOrExpr
#line 348 "frontend/parser.y"
            {
    yylhs.value.as < ast::ExprPtr > () = yystack_[0].value.as < ast::ExprPtr > ();
  }
#line 1297 "frontend/generated/parser.cpp"
    break;
...
#line 1305 "frontend/generated/parser.cpp"
    break;
...
#line 1313 "frontend/generated/parser.cpp"
    break;

  case 51: // PrimaryExpr: INTEGER
#line 360 "frontend/parser.y"
            {
    yylhs.value.as < ast::ExprPtr > () = ast::create_constant_expr(yystack_[0].value.as < ComptimeValuePtr > ());
  }
#line 1321 "frontend/generated/parser.cpp"
    break;
...
#line 1329 "frontend/generated/parser.cpp"
    break;
...
#line 1342 "frontend/generated/parser.cpp"
    break;
...
#line 1352 "frontend/generated/parser.cpp"
    break;

  case 55: // AssignStmt: LVal '=' Expr ';'
#line 385 "frontend/parser.y"
                      {
    yylhs.value.as < ast::StmtPtr > () = ast::create_assign_stmt(yystack_[3].value.as < ast::ExprPtr > (), yystack_[1].value.as < ast::ExprPtr > (), driver);
  }
#line 1360 "frontend/generated/parser.cpp"
    break;
...
#line 1368 "frontend/generated/parser.cpp"
    break;
...
#line 1376 "frontend/generated/parser.cpp"
    break;
...
#line 1384 "frontend/generated/parser.cpp"
    break;
...
#line 1392 "frontend/generated/parser.cpp"
    break;
...
#line 1416 "frontend/generated/parser.cpp"
    break;
...
#line 1460 "frontend/generated/parser.cpp"
    break;
...
#line 1469 "frontend/generated/parser.cpp"
    break;
...
#line 1495 "frontend/generated/parser.cpp"
    break;
...
#line 1521 "frontend/generated/parser.cpp"
    break;
...
#line 1530 "frontend/generated/parser.cpp"
    break;
...
#line 1539 "frontend/generated/parser.cpp"
    break;
...
#line 1565 "frontend/generated/parser.cpp"
    break;
...
#line 1651 "frontend/generated/parser.cpp"
    break;
...
#line 1659 "frontend/generated/parser.cpp"
    break;
...
#line 1683 "frontend/generated/parser.cpp"
    break;

  case 87: // FuncParam: Type IDENTIFIER '[' ']'
#line 586 "frontend/parser.y"
                            {
    yylhs.value.as < std::tuple<TypePtr, std::string> > () = std::make_tuple(create_array_type(yystack_[3].value.as < TypePtr > (), std::nullopt), yystack_[2].value.as < std::string > ());
  }
#line 1691 "frontend/generated/parser.cpp"
    break;
...
#line 1717 "frontend/generated/parser.cpp"
    break;
...
#line 1751 "frontend/generated/parser.cpp"
    break;


#line 1755 "frontend/generated/parser.cpp"
...
#undef YYCASE_
   ...
   Parser ::yyrline_[] =
  {
     ...
     151,   157,   160,   167,   178,   191,   194,   213,   227,   254,
     257,   264,   267,   270,   276,   279,   286,   289,   295,   301,
     304,   310,   316,   322,   322,   328,   335,   342,   348,   354,
     357,   360,   363,   369,   377,   385,   391,   394,   397,   400,
     403,   422,   456,   459,   463,   467,   474,   477,   481,   488,
     491,   495,   499,   503,   510,   513,   517,   524,   527,   534,
     537,   544,   547,   554,   557,   564,   567,   586,   589,   613,
     620,   626
  };
...
#line 2349 "frontend/generated/parser.cpp"
